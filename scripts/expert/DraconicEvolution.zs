...
recipes.addShaped(<draconicevolution:dislocator>, [[<botania:blazeblock>, <thermalfoundation:storage_alloy:7>, <botania:blazeblock>], [<thermalfoundation:storage_alloy:7>, <draconicevolution:wyvern_core>, <thermalfoundation:storage_alloy:7>], [<botania:blazeblock>, <thermalfoundation:storage_alloy:7>, <botania:blazeblock>]]);
